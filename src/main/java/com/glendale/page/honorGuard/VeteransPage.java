...
public class VeteransPage {
	
	WebDriver driver;
	
	public VeteransPage(WebDriver driver) {
		this.driver = driver;
	...
	@FindBy(xpath = "//div[@data-list-name='Category: Veterans']/ul[@class='productGrid']/li")
	...
	public void methodToOpenTheVeteransPage() {
		Actions action = new Actions(driver);
		action.moveToElement(honorGuardTab).build().perform();
		listOfHonorGuard.get(2).click();
	}

	public void verifyPageURL() {
		methodToOpenTheVeteransPage();
		String currentURL = driver.getCurrentUrl();
		String expURL = "https://www.glendale.com/veterans/";
	...
	public void verifyPageTitle() {
		...
		String expTitle = "Veterans | Veterans Accessories | Glendale Parade Store";
