...
import com.glendale.page.Uniforms.AchievementMedalsPage;

public class AchievementMedals_Test extends BaseClass{

	AchievementMedalsPage obj;
	
	@BeforeMethod
	public void loadObject() {
		obj = new AchievementMedalsPage(driver);
	}
	@Test
