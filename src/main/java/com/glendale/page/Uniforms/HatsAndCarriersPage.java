...
public class HatsAndCarriersPage {
	
	WebDriver driver;
	
	public HatsAndCarriersPage(WebDriver driver) {
		this.driver = driver;
	...
	@FindBy(xpath = "//div[@data-list-name='Category: Hats & Carriers']/ul[@class='productGrid']/li")
	...
	public void methodToOpenTheHatsAndCarriersPage() {
		Actions action = new Actions(driver);
		action.moveToElement(uniformTab).build().perform();
		uniformsList.get(11).click();
	}

	public void verifyPageURL() {
		methodToOpenTheHatsAndCarriersPage();
		String currentURL = driver.getCurrentUrl();
		String expURL = "https://www.glendale.com/uniforms/hats-carriers/";
	...
	public void verifyPageTitle() {
		...
		String expTitle = "Uniforms - Hats & Carriers - Page 1 - Glendale Parade Store";
	...
	public void verifyTextPresenceAndFontSize() {
		...
		for (int i = 0; i < textOnThePage.size(); i++) {
			...
			String expText = "When you need to keep those important uniform accessories";
