...
public class CoastGuardPage {
	...
	@FindBy(xpath  = "//div[@class='gld-flag-banner gld-inner-banner-with-desc gld-banner-long-desc cguard-active-duty-banner']")
	WebElement banner;
	@FindBy(xpath = "//a[@href=\"/military/coast-guard/\"]")
	WebElement shopNowBbuttonOnTheBanner;
	@FindBy(xpath = "//div[@class='gld-flag-txt']/p[contains(text(),'Since 1790, the Coast Guard has safeguarded the American people and')]")
	...
	@FindBy(xpath = "//div[@class='gld-feat-simlr cguard-flags-bg']/h3")
	WebElement fc_Flags;
	@FindBy(xpath = "//div[@class='gld-feat-simlr cguard-flags-bg']/ul/li/a")
	...
	@FindBy(xpath = "//div[@class='gld-feat-simlr cguard-caremonials-bg']/h3")
	...
	public void verifyTextOnTheBanner() {
		...
		System.out.println("Text on the banner is Presnt.");
	}
