...
public class MourningFlagsPage {
	
	WebDriver driver;
	
	public MourningFlagsPage(WebDriver driver) {
		this.driver = driver;
	...
	@FindBy(xpath = "//div[@data-list-name='Category: Mourning Flags']/ul[@class='productGrid']/li")
	...
	public void methodToOpenTheMourningFlagsPage() {
		Actions action = new Actions(driver);
		action.moveToElement(flags_Tab).build().perform();
		flagsDropdownList.get(6).click();
	}

	public void verifyPageURL() {
		methodToOpenTheMourningFlagsPage();
		String currentURL = driver.getCurrentUrl();
		String expURL = "https://www.glendale.com/flags/mourning-flags/";
