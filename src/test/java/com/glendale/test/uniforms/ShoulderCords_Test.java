...
import com.glendale.page.Uniforms.ShoulderCordsPage;

public class ShoulderCords_Test extends BaseClass{
	
	ShoulderCordsPage obj;

	@BeforeMethod
	public void loadObject() {
		obj = new ShoulderCordsPage(driver);
	}
	@Test
