...
import com.glendale.page.flags.FlagCoversAndCasesPage;

public class FlagCoversAndCases_Test extends BaseClass{
	
	FlagCoversAndCasesPage obj;
	
	@BeforeMethod
	public void loadObject() {
	obj = new FlagCoversAndCasesPage(driver);
	}
	@Test
