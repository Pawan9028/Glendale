...
public class PinsAndTabsPage {

	WebDriver driver;
	
	public PinsAndTabsPage(WebDriver driver) {
		this.driver = driver;
	...
	@FindBy(xpath = "//div[@data-list-name='Category: Pins & Tabs']/ul[@class='productGrid']/li")
	...
	public void methodToOpenThePinsAndTabsPage() {
		Actions action = new Actions(driver);
		action.moveToElement(uniformTab).build().perform();
		uniformsList.get(13).click();
	}

	public void verifyPageURL() {
		methodToOpenThePinsAndTabsPage();
		String currentURL = driver.getCurrentUrl();
		String expURL = "https://www.glendale.com/uniforms/pins-tabs/";
	...
	public void verifyPageTitle() {
		...
		String expTitle = "Uniforms - Pins & Tabs - Page 1 - Glendale Parade Store";
	...
	public void verifyTextPresenceAndFontSize() {
		methodToOpenThePinsAndTabsPage();
			...
			String expText = "Add a signature touch to your uniform with these military pins and tabs from";
