...
public class NavyPage {
	...
	@FindBy(xpath  = "//div[@class='gld-flag-banner gld-inner-banner-with-desc gld-banner-long-desc navy-jrotc-banner']")
	WebElement banner;
	@FindBy(xpath = "//a[@href='/content/pdf/JROTC_Trifold_2024_F1.pdf']")
	WebElement viewJROTCTrifoldBbuttonOnTheBanner;
	@FindBy(xpath = "//div[@class='gld-flag-txt']/p[contains(text(),'The NJROTC program was established')]")
	...
	@FindBy(xpath = "//div[@class='gld-feat-simlr navypg-teams-bg']/h3")
	WebElement fc_Teams;
	@FindBy(xpath = "//div[@class='gld-feat-simlr navypg-teams-bg']/ul/li/a")
	...
	@FindBy(xpath = "//div[@class='gld-feat-simlr navypg-glags-bg']/h3")
	WebElement fc_flags;
	@FindBy(xpath = "//div[@class='gld-feat-simlr navypg-glags-bg']/ul/li/a")
	...
	@FindBy(xpath = "//div[@id='sd-product-set-carousel-31391132-d99f-46d9-9294-64a18949299e']/div/div/div")
	...
	public void methodToOpenTheArmyPage()  {
		...
		codetsDropdownList.get(5).click();
	}
	...
	public void verifyTextOnTheBanner() throws InterruptedException {
		methodToOpenTheArmyPage();
		String expText = "The NJROTC program was established";
