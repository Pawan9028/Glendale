...
public class ArmyPage {
	...
	@FindBy(xpath = "//div[@id='sd-product-set-carousel-f3c64c59-a72c-4b3e-8157-c9936dbe4fab']/div/div/div")
	...
	public void verifyBannerIsPresenceAndShopNowButtonRedirection() throws InterruptedException {
		...
		String href2 = viewAGSUTrifoldBbuttonOnTheBanner.getAttribute("href");
		driver.navigate().to(href2);
		String expSubString2 = "www.glendale.com"; 
		Assert.assertTrue(driver.getCurrentUrl().contains(expSubString2), "VIEW JROTC TRIFOLD button is not redirected to the Shopping page");
