...
public class AccessoriesPage {
	...
	@FindBy(xpath = "//div[@data-list-name='Category: Accessories']/ul[@class='productGrid']/li")
	...
	public void methodToOpenTheAccessoriesPage() {
		Actions action = new Actions(driver);
		action.moveToElement(uniformTab).build().perform();
		uniformsList.get(2).click();
	}

	public void verifyPageURL() {
		methodToOpenTheAccessoriesPage();
		String currentURL = driver.getCurrentUrl();
		String expURL = "https://www.glendale.com/uniforms/accessories/";
	...
	public void verifyPageTitle() {
		...
		String expTitle = "Uniforms - Accessories - Page 1 - Glendale Parade Store";
	...
	public void verifyTextPresenceAndFontSize() {
		...
		String expText = "As any military or ROTC member knows, dress is something that is ";
