...
import com.glendale.page.flags.FlagOrnamentsPage;

public class FlagOrnaments_Test extends BaseClass{
	
	FlagOrnamentsPage obj;
	
	@BeforeMethod
	public void loadObject() {
		obj = new FlagOrnamentsPage(driver);
	}
	@Test
