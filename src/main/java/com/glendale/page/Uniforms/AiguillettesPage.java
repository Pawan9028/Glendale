...
public class AiguillettesPage {
	
	WebDriver driver;
	
	public AiguillettesPage(WebDriver driver) {
		this.driver = driver;
	...
	@FindBy(xpath = "//div[@data-list-name='Category: Aiguillettes']/ul[@class='productGrid']/li")
	...
	public void methodToOpenTheAiguillettesPage() {
		Actions action = new Actions(driver);
		action.moveToElement(uniformTab).build().perform();
		uniformsList.get(3).click();
	}

	public void verifyPageURL() {
		methodToOpenTheAiguillettesPage();
		String currentURL = driver.getCurrentUrl();
		String expURL = "https://www.glendale.com/uniforms/aiguillettes/";
	...
	public void verifyPageTitle() {
		...
		String expTitle = "Uniforms - Aiguillettes - Glendale Parade Store";
	...
	public void verifyTextPresenceAndFontSize() {
		...
		String expText = "In the military, making a good impression starts";
