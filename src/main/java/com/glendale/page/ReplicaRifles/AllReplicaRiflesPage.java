...
public class AllReplicaRiflesPage {

	WebDriver driver;
	
	public AllReplicaRiflesPage(WebDriver driver) {
		this.driver = driver;
	...
	@FindBy(xpath = "//div[@data-list-name='Category: Replica Rifles']/ul[@class='productGrid']/li")
	...
	public void methodToOpenTheAllReplicaRiflesPage() {
	...
	public void verifyPageURL() {
		methodToOpenTheAllReplicaRiflesPage();
		String currentURL = driver.getCurrentUrl();
		String expURL = "https://www.glendale.com/replica-rifles/";
	...
	public void verifyPageTitle() {
		...
		String expTitle = "Replica Rifles - Glendale Parade Store";
