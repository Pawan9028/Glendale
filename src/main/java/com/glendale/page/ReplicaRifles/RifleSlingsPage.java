...
public class RifleSlingsPage {
	
	WebDriver driver;
	
	public RifleSlingsPage(WebDriver driver) {
		this.driver = driver;
	...
	@FindBy(xpath = "//div[@data-list-name='Category: Rifle Slings']/ul[@class='productGrid']/li")
	...
	public void methodToOpenTheRifleSlingsPage() {
	...
	public void verifyPageURL() {
		...
		String expURL = "https://www.glendale.com/replica-rifles/rifle-slings/";
