...
import com.glendale.page.Uniforms.BeltsAndBucklesPage;

public class BeltsAndBuckles_Test extends BaseClass{
	
	BeltsAndBucklesPage obj;

	@BeforeMethod
	public void loadObject() {
		obj = new BeltsAndBucklesPage(driver);
	}
	@Test
