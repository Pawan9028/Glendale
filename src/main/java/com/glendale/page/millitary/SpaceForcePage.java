...
public class SpaceForcePage {

WebDriver driver;
	
	public SpaceForcePage(WebDriver driver) {
		this.driver = driver;
	...
	@FindBy(xpath  = "//div[@class='gld-flag-banner gld-inner-banner-with-desc gld-banner-long-desc space-active-duty-banner']")
	WebElement banner;
	@FindBy(xpath = "//a[@href=\"/space-force-active-duty/\"]")
	WebElement shopNowBbuttonOnTheBanner;
	@FindBy(xpath = "//div[@class='gld-flag-txt']/p[contains(text(),\"The U.S. Space Force\")]")
	...
	@FindBy(xpath = "//div[@class='gld-feat-simlr space-force-ad-flags-bg']/h3")
	WebElement fc_Flags;
	@FindBy(xpath = "//div[@class='gld-feat-simlr space-force-ad-flags-bg']/ul/li/a")
	...
	@FindBy(xpath = "//div[@class='gld-feat-simlr caremonials-us-af-bg']/h3")
	...
	@FindBy(xpath = "//div[@id='sd-product-set-carousel-ca0a6890-083c-4680-ac14-bfe3b85863dd']/div/div/div")
	...
	public void verifyTextOnTheBanner() throws InterruptedException {
		methodToOpenTheSpaceForcePage();
		String expText = "The U.S. Space Force";
