...
public class SwordsAndSabersPage {
	
	WebDriver driver;
	
	public SwordsAndSabersPage(WebDriver driver) {
		this.driver =driver;
	...
	@FindBy(xpath = "//div[@data-list-name='Category: Swords & Sabers']/ul[@class='productGrid']/li")
	...
	public void methodToOpenTheSwordsAndSabbersPage() {
		Actions action = new Actions(driver);
		action.moveToElement(uniformTab).build().perform();
		uniformsList.get(17).click();
	}
