...
public class ArmyGrennServiceUnigormPage {
	
	WebDriver driver ;
	
	public ArmyGrennServiceUnigormPage(WebDriver driver) {
		this.driver = driver;
	...
	@FindBy(xpath = "//div[@data-list-name='Category: Army Green Service Uniform']/ul[@class='productGrid']/li")
	...
	public void methodToOpenTheArmyGreenServiceUniformPage() {
		Actions action = new Actions(driver);
		action.moveToElement(uniformTab).build().perform();
		uniformsList.get(6).click();
	}

	public void verifyPageURL() {
		methodToOpenTheArmyGreenServiceUniformPage();
		String currentURL = driver.getCurrentUrl();
		String expURL = "https://www.glendale.com/uniforms/army-green-service-uniform/";
