...
public class FlagCoversAndCasesPage {
	
	WebDriver driver;
	
	public FlagCoversAndCasesPage(WebDriver driver) {
		this.driver = driver;
	...
	@FindBy(xpath = "//div[@data-list-name='Category: Flag Covers & Cases']/ul[@class='productGrid']/li")
	...
	public void methodToOpenTheFlagCoversAndCasesPage() {
		Actions action = new Actions(driver);
		action.moveToElement(flags_Tab).build().perform();
		flagsDropdownList.get(2).click();
	}

	public void verifyPageURL() {
		methodToOpenTheFlagCoversAndCasesPage();
		String currentURL = driver.getCurrentUrl();
		String expURL = "https://www.glendale.com/flags/flag-covers-cases/";
	...
	public void verifyPageTitle() {
		...
		String expTitle = "Flags - Flag Covers & Cases - Page 1 - Glendale Parade Store";
	...
	public void verifyTextOnThePage() {
		methodToOpenTheFlagCoversAndCasesPage();
			...
			String extTest = "Flags are an enduring symbol of some of the most important things ";
