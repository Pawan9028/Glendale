...
public class FlagOrnamentsPage {
	
	WebDriver driver;
	
	public FlagOrnamentsPage(WebDriver driver) {
		this.driver = driver;
	...
	@FindBy(xpath = "//div[@data-list-name='Category: Flag Ornaments']/ul[@class='productGrid']/li")
	...
	public void methodToOpenTheFlagOrnamentsPage() {
		Actions action = new Actions(driver);
		action.moveToElement(flags_Tab).build().perform();
		flagsDropdownList.get(3).click();
	}

	public void verifyPageURL() {
		methodToOpenTheFlagOrnamentsPage();
		String currentURL = driver.getCurrentUrl();
		String expURL = "https://www.glendale.com/flags/flag-ornaments/";
	...
	public void verifyPageTitle() {
		...
		String expTitle = "Flags - Flag Ornaments - Page 1 - Glendale Parade Store";
	...
	public void verifyTextOnThePage() {
		methodToOpenTheFlagOrnamentsPage();
			...
			String extText = "Put the finishing touch on a beautiful flag display by";
			Assert.assertTrue(actText.contains(extText),"Actual text doesn't matched with the expectd text.");
