...
import com.glendale.page.Uniforms.ArmyGrennServiceUnigormPage;

public class ArmyGreenServiceUniform_Test extends BaseClass{
	
	ArmyGrennServiceUnigormPage obj;
	
	@BeforeMethod
	public void loadObject() {
		obj = new ArmyGrennServiceUnigormPage(driver);
	}
	@Test
