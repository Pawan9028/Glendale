...
import com.glendale.page.Uniforms.ShoesAndAccessoriesPage;

public class ShoesAndAccessories_Test extends BaseClass{
	
	ShoesAndAccessoriesPage obj;

	@BeforeMethod
	public void loadObject() {
		obj = new ShoesAndAccessoriesPage(driver);
	}
	@Test
