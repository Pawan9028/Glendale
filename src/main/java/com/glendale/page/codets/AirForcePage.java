...
public class AirForcePage {
	...
	@FindBy(xpath = "//div[@class='gld-feat-simlr teams-bg-newafjr']/h3")
	WebElement fc_Teams;
	@FindBy(xpath = "//div[@class='gld-feat-simlr teams-bg-newafjr']/ul/li/a")
	...
	@FindBy(xpath = "//div[@class='gld-feat-simlr teams-bg-newflgs']/h3")
	WebElement fc_flags;
	...
	public void methodToOpenTheArmyPage()  {
		...
		codetsDropdownList.get(2).click();
	}
	...
	public void verifyTextOnTheBanner() throws InterruptedException {
		methodToOpenTheArmyPage();
		String expText = "The mission of Air Force Junior ROTC is to";
