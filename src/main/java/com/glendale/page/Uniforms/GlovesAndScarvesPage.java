...
public class GlovesAndScarvesPage {

	WebDriver driver;

	public GlovesAndScarvesPage(WebDriver driver) {
		this.driver = driver;
	...
	@FindBy(xpath = "//div[@data-list-name='Category: Gloves & Scarves']/ul[@class='productGrid']/li")
	...
	public void methodToOpenTheGlovesAndScarvesPage() {
		Actions action = new Actions(driver);
		action.moveToElement(uniformTab).build().perform();
		uniformsList.get(9).click();
	}

	public void verifyPageURL() {
		methodToOpenTheGlovesAndScarvesPage();
		String currentURL = driver.getCurrentUrl();
		String expURL = "https://www.glendale.com/uniforms/gloves-scarves/";
	...
	public void verifyPageTitle() {
		...
		String expTitle = "Uniforms - Gloves & Scarves - Page 1 - Glendale Parade Store";
	...
	public void verifyTextPresenceAndFontSize() {
		...
		for (int i = 0; i < textOnThePage.size(); i++) {
			...
			String expText = "Some of our most popular gloves at";
