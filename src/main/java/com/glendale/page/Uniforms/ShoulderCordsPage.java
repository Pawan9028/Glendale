...
public class ShoulderCordsPage {
	
	WebDriver driver;
	
	public ShoulderCordsPage(WebDriver driver) {
		this.driver = driver;
	...
	@FindBy(xpath = "//div[@data-list-name='Category: Shoulder Cords']/ul[@class='productGrid']/li")
	...
	public void methodToOpenTheShoulderCordsPage() {
		Actions action = new Actions(driver);
		action.moveToElement(uniformTab).build().perform();
		uniformsList.get(16).click();
	}

	public void verifyPageURL() {
		methodToOpenTheShoulderCordsPage();
		String currentURL = driver.getCurrentUrl();
		String expURL = "https://www.glendale.com/uniforms/shoulder-cords/";
	...
	public void verifyPageTitle() {
		...
		String expTitle = "Uniforms - Shoulder Cords - Page 1 - Glendale Parade Store";
	...
	public void verifyTextPresenceAndFontSize() {
		methodToOpenTheShoulderCordsPage();
			...
			String expText = "Complete your military uniform with the help of these military";
