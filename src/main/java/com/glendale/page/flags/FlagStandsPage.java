...
public class FlagStandsPage {
	
	WebDriver driver;
	
	public FlagStandsPage(WebDriver driver) {
		this.driver = driver;
	...
	@FindBy(xpath = "//div[@data-list-name='Category: Flag Stands']/ul[@class='productGrid']/li")
	...
	public void methodToOpenTheFlagStandsPage() {
		Actions action = new Actions(driver);
		action.moveToElement(flags_Tab).build().perform();
		flagsDropdownList.get(5).click();
	}

	public void verifyPageURL() {
		methodToOpenTheFlagStandsPage();
		String currentURL = driver.getCurrentUrl();
		String expURL = "https://www.glendale.com/flags/flag-stands/";
	...
	public void verifyPageTitle() {
		...
		String expTitle = "Flags - Flag Stands - Page 1 - Glendale Parade Store";
	...
	public void verifyTextOnThePage() {
		methodToOpenTheFlagStandsPage();
			...
			String extText = "Let your flag fly in the breeze, stand tall in a stadium o";
