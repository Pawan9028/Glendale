...
public class FlagPolesPage {
	
	WebDriver driver;
	
	public FlagPolesPage(WebDriver driver) {
		this.driver = driver;
	...
	@FindBy(xpath = "//div[@data-list-name='Category: Flag Poles']/ul[@class='productGrid']/li")
	...
	public void methodToOpenTheFlagPolesPage() {
	...
	public void verifyTextOnThePage() {
		methodToOpenTheFlagPolesPage();
			...
			String extText = "Let your flag fly in the breeze, stand tall in a stadium or ";
