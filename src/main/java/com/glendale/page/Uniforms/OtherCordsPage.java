...
public class OtherCordsPage {
	
	WebDriver driver;
	
	public OtherCordsPage(WebDriver driver) {
		this.driver = driver;
	...
	@FindBy(xpath = "//div[@data-list-name='Category: Other Cords']/ul[@class='productGrid']/li")
	...
	public void methodToOpenTheOtherCordsPage() {
		Actions action = new Actions(driver);
		action.moveToElement(uniformTab).build().perform();
		uniformsList.get(12).click();
	}

	public void verifyPageURL() {
		methodToOpenTheOtherCordsPage();
		String currentURL = driver.getCurrentUrl();
		String expURL = "https://www.glendale.com/uniforms/other-cords/";
	...
	public void verifyPageTitle() {
		...
		String expTitle = "Uniforms - Other Cords - Page 1 - Glendale Parade Store";
	...
	public void verifyTextPresenceAndFontSize() {
		...
		for (int i = 0; i < textOnThePage.size(); i++) {
			...
			String expText = "One of the great things about ordering your";
