...
public class BadgeHoldersAndWalletsPage {
	
	WebDriver driver;
	
	public BadgeHoldersAndWalletsPage(WebDriver driver) {
		this.driver = driver;
	...
	@FindBy(xpath = "//div[@data-list-name='Category: Badge Holders & Wallets']/ul[@class='productGrid']/li")
	...
	public void methodToOpenTheBadgesHoldersAndWalletsPage() {
		Actions action = new Actions(driver);
		action.moveToElement(firstResponder_Tab).build().perform();
		firstResponderDropdownList.get(1).click();
	}

	public void verifyPageURL() {
		methodToOpenTheBadgesHoldersAndWalletsPage();
		String currentURL = driver.getCurrentUrl();
		String expURL = "https://www.glendale.com/first-responders/badge-holders-and-wallets/";
