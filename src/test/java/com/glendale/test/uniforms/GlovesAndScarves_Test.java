...
import com.glendale.page.Uniforms.GlovesAndScarvesPage;

public class GlovesAndScarves_Test extends BaseClass{
	GlovesAndScarvesPage obj;
	
	@BeforeMethod
	public void loadObject() {
		obj = new GlovesAndScarvesPage(driver);
	}
	@Test
