...
public class RifleAccessoriesPage {
	
	WebDriver driver;
	
	public RifleAccessoriesPage(WebDriver driver) {
		this.driver = driver;
	...
	@FindBy(xpath = "//div[@data-list-name='Category: Rifle Accessories']/ul[@class='productGrid']/li")
	...
	public void methodToOpenTheRifleAccessoriesPage() {
		Actions action = new Actions(driver);
		action.moveToElement(firstResponder_Tab).build().perform();
		firstResponderDropdownList.get(4).click();
	}

	public void verifyPageURL() {
		methodToOpenTheRifleAccessoriesPage();
		String currentURL = driver.getCurrentUrl();
		String expURL = "https://www.glendale.com/replica-rifles/rifle-accessories/";
	...
	public void verifyPageTitle() {
		...
		String expTitle = "Replica Rifles - Rifle Accessories - Page 1 - Glendale Parade Store";
	...
	public void verifyTextOnThePage() {
		methodToOpenTheRifleAccessoriesPage();
			...
			String extTest = "If you’ve ever wanted to renew, repair or";
