...
public class CoastGuardPage {
	
	WebDriver driver;
	
	public CoastGuardPage(WebDriver driver) {
		this.driver = driver;
	...
	@FindBy(xpath  = "//div[@class='gld-flag-banner gld-inner-banner-with-desc coast-guard-banner']")
	WebElement banner;
	@FindBy(xpath = "//a[@href='/content/pdf/JROTC_Trifold_2024_F1.pdf']")
	WebElement viewJROTCTrifoldBbuttonOnTheBanner;
	@FindBy(xpath = "//div[@class='gld-flag-txt']/p[contains(text(),'The Coast Guard established its first JROTC')]")
	...
	@FindBy(xpath = "//div[@class='gld-feat-simlr coastguard-teams-bg']/h3")
	WebElement fc_Teams;
	@FindBy(xpath = "//div[@class='gld-feat-simlr coastguard-teams-bg']/ul/li/a")
	...
	@FindBy(xpath = "//div[@class='gld-feat-simlr coastguard-flags-bg']/h3")
	WebElement fc_flags;
	@FindBy(xpath = "//div[@class='gld-feat-simlr coastguard-flags-bg']/ul/li/a")
	...
	@FindBy(xpath = "//div[@id='sd-product-set-carousel-87cc32d4-98cf-4248-9c56-340eec5169fa']/div/div/div")
	...
	public void methodToOpenTheArmyPage()  {
		...
		codetsDropdownList.get(3).click();
	}
	...
	public void verifyTextOnTheBanner() throws InterruptedException {
		methodToOpenTheArmyPage();
		String expText = "The Coast Guard established its first JROTC";
