...
import com.glendale.page.ReplicaRifles.AllReplicaRiflesPage;

public class AllReplicaRiflesPage_Test extends BaseClass{
	
	AllReplicaRiflesPage obj;
	
	@BeforeMethod
	public void loadObject() {
		obj = new AllReplicaRiflesPage(driver);
	}
	@Test
