...
import com.glendale.page.Uniforms.HatsAndCarriersPage;

public class HatsAndCarriers_Test extends BaseClass{
	
	HatsAndCarriersPage obj;
	
	@BeforeMethod
	public void loadObject() {
		obj = new HatsAndCarriersPage(driver);
	}
	@Test
