...
public class GarmentAndGearBagsPage {
	
	WebDriver driver;
	
	public GarmentAndGearBagsPage(WebDriver driver) {
		this.driver = driver;
	...
	@FindBy(xpath = "//div[@data-list-name='Category: Garment & Gear Bags']/ul[@class='productGrid']/li")
	...
	public void methodToOpenTheGarmentsAndGearPage() {
		Actions action = new Actions(driver);
		action.moveToElement(uniformTab).build().perform();
		uniformsList.get(10).click();
	}

	public void verifyPageURL() {
		methodToOpenTheGarmentsAndGearPage();
		String currentURL = driver.getCurrentUrl();
		String expURL = "https://www.glendale.com/uniforms/garment-gear-bags/";
	...
	public void verifyPageTitle() {
		...
		String expTitle = "Uniforms - Garment & Gear Bags - Glendale Parade Store";
	...
	public void verifyTextPresenceAndFontSize() {
		...
		for (int i = 0; i < textOnThePage.size(); i++) {
			...
			String expText = "These bags can be used by those in the Army,";
