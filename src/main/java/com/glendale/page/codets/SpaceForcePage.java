...
public class SpaceForcePage {
	...
	@FindBy(xpath = "//div[@class='gld-feat-simlr spcforce-teams-bg']/h3")
	WebElement fc_Teams;
	@FindBy(xpath = "//div[@class='gld-feat-simlr spcforce-teams-bg']/ul/li/a")
	...
	@FindBy(xpath = "//div[@class='gld-feat-simlr spcforce-flags-bg']/h3")
	WebElement fc_flags;
	@FindBy(xpath = "//div[@class='gld-feat-simlr spcforce-flags-bg']/ul/li/a")
	...
	public void methodToOpenTheArmyPage()  {
		...
		codetsDropdownList.get(6).click();
	}
	...
	public void verifyTextOnTheBanner() throws InterruptedException {
		methodToOpenTheArmyPage();
		String expText = "The purpose of the Space Force Junior";
