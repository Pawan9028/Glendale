...
public class RiflesPage {
	
	WebDriver driver;
	
	public RiflesPage(WebDriver driver) {
		this.driver = driver;
	...
	@FindBy(xpath = "//div[@data-list-name='Category: Rifles']/ul[@class='productGrid']/li")
	...
	public void methodToOpenTheRiflesPage() {
	...
	public void verifyPageURL() {
		methodToOpenTheRiflesPage();
		String currentURL = driver.getCurrentUrl();
		String expURL = "https://www.glendale.com/replica-rifles/rifles/";
	...
	public void verifyPageTitle() {
		...
		String expTitle = "Replica Rifles - Rifles - Glendale Parade Store";
